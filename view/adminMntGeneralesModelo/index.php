...
<body>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                      <a href="#"  class="btn bg-teal text-teal-fg d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modalModelo">
                ...
                <div class="card-body">
                  <div class="table-responsive mx-4">
                    <div class="row my-4">
                      ...
                      <div class="col-lg-3">
                        <label  class="form-label" for="cantidad_registros">Buscar Modelo:</label>
                        <div class="input-icon">
                            <span class="input-icon-addon">
    ...
    <?php require_once("modalModelo.php"); ?>
