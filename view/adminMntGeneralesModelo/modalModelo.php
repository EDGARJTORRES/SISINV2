                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="modelo_nom" name="modelo_nom" pattern="^[A-Za-zÁÉÍÓÚáéíóúÑñ0-9 ]{3,50}$" title="Solo letras, números y espacios. Mínimo 3 caracteres."maxlength="50">
