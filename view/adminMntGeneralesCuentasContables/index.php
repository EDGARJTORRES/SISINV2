...
<head>
  ...
  <link href="../../public/css/cuenta.css" rel="stylesheet"/>
...
<body>
                ...
                <div class="card border-0" style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                  ...
                  <div class="card-body text-center">
                    <p class="text-muted mb-3">
                      Crea y organiza nuevas cuentas contables para una mejor gestión de bienes.
                    </p>
                    <button class="button2" id="add_button" onclick = "nuevacuenta()">
                  ...
                  <div class="card-header">
                    <h3 class="card-title">
                      <svg class="text-primary" xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-list-search"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 15m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M18.5 18.5l2.5 2.5" /><path d="M4 6h16" /><path d="M4 12h4" /><path d="M4 18h4" /></svg>
                        LISTADO DE REGISTROS DE CUENTAS CONTABLES
                    </h3>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive mx-4">
                      <div class="row my-3">
                        <div class="col-lg-12">
                          <div class="d-flex flex-wrap align-items-center gap-3">
                            <div class="d-flex align-items-center gap-2">
                              <button type="button" class="btn bg-black text-light" id="eliminar_cuentas">
                        ...
                        <table id="cuenta_data"  class="table card-table table-vcenter text-nowrap datatable" style="width: 99%;">
                            <thead>
                                <tr>
                                  <th><input type="checkbox" id="cuenta_id_all"> </th>
      ...
      <div class="success-alert">
        <div class="content-left">
          ...
          <div class="text-content">
            <p class="title">Cargando Cuentas Contables... :)</p>
    ...
    <?php require_once("modalcuenta.php"); ?>
