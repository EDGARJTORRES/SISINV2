              ...
              <nav class="breadcrumb mb-3">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none mb-3">
                        <div class="btn-list">
                            <button class="Btn" onclick="window.location.href = '../adminAltaBien/';">
                    ...
                    <div class="card_body my-3">
                        ...
                        <div class="row m-4">
                          <div class="col-md-8 mb-3">
                              ...
                              <select class="form-select select2" id="bien_id" name="bien_id" data-placeholder="Seleccione tipo de Vehículo" style="width: 100%;">
                          ...
                          <div class="col-md-4 mb-3">
                            ...
                            <div class="input-icon mb-1">
                                ...
                                <input type="text" class="form-control" id="ruta" name="ruta" placeholder="Ej: Lima - Arequipa">
                            </div>
                          </div>
                          <div class="col-md-4 mb-3">
                          ...
                          <div class="col-md-4 mb-3">
                              ...
                              <div class="input-icon mb-1">
                                  ...
                                  <input type="number" step="0.01" min="0.01" class="form-control" id="carga_util" name="carga_util" placeholder="Ej: 750.00 kg">
                              </div>
                          </div>
                          <div class="col-md-4 mb-3">
                          ...
                          <div class="col-md-4 mb-3">
                          <label for="comb_id" class="form-label">ID Combustible <span class="text-danger">*</span></label>
                          <input type="number" class="form-control" id="comb_id" name="comb_id" placeholder="Ingrese ID de combustible">
                          </div>
                        </div>
                        </form>
                    </div>
