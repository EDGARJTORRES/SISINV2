<div id="modalObjetoCate" class="modal fade" data-backdrop="static" data-keyboard="false" style="overflow-y: scroll;">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <select class="form-control select2" style="width: 100%" id="combo_cate_depe_obj" name="combo_cate_depe_obj" required>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control tx-uppercase" style="width: 100%" id="reg_patrim" type="text" name="reg_patrim" required />
                                </div>
