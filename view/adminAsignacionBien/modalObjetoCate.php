                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <select class="form-control select2" style="width: 100%" id="combo_gg_bien_obj" name="combo_gg_bien_obj" required>

                                    </select>
                                </div>
                                <label class="form-control-label">Clase:<span class="tx-danger">*</span></label>
                                <div class="form-group">
                                    <select class="form-control select2" style="width: 100%" id="combo_clase_bien_obj" name="combo_clase_bien_obj" required>

                                    </select>
                                </div>
                                <label class="form-control-label">Objeto: <span class="tx-danger">*</span></label>
                                <div class="form-group">
                                    <select class="form-control select2" style="width: 100%" id="combo_obj_bien" name="combo_obj_bien" required>

                                    </select>
                                </div>
                                <label class="form-control-label">Color: <span class="tx-danger">*</span></label>
                                <div class="form-group">
                                    <select class="form-control select2" style="width: 100%" data-placeholder="Color"  id="combo_color_bien" name="combo_color_bien" multiple require>
                                    </select>
                                </div><!-- col-4 -->
                                <div class="container">
                                    <div class="row" style="margin-left: -30px;  margin-right: -30px;">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control select2" style="width: 100%" id="combo_modelo_obj" name="combo_modelo_obj" required>
                                ...
                                <div class="form-group">
                                    <input class="form-control tx-uppercase" style="width: 100%" id="bien_numserie" type="text" name="bien_numserie" required />
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="countiner">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input class="form-control tx-uppercase" style="width: 100%" id="codigo_barras_input" type="text" name="codigo_barras_input" readonly required />
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="margin-top: -3px;">
                                    <input class="form-control tx-uppercase" style="width: 100%" id="cod_interno" type="text" name="cod_interno" readonly required />
                                </div>
                                <label class="form-control-label">Dimensiones <span class="tx-danger">*</span></label>
                                <div class="form-group">
