          ...
          <div class="col-12 mb-3">
            ...
            <div class="row mb-3 align-items-stretch">
              <div class="col-6 col-lg-3 mb-2">
                <div class="card border-0 h-100"  style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                  ...
                  <div class="card-body placeholder-glow" id="placeholder-totales">
                    <h3 class="card-title text-yellow">
                    ...
                    <div class="row text-center">
                      ...
                      <div class="col-lg-8" style=" align-content: center;">
                        <h2 id="lbltotabien" class="placeholder col-8"></h2>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-6 col-lg-3 mb-2 ">
                <div class="card border-0 h-100" style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                  ...
                  <div class="card-body placeholder-glow" id="placeholder-adquisicion">
                    ...
                    <div class="row text-center">
                      ...
                      <div class="col-lg-8" style="align-content: center;">
                        <h4 class="placeholder col-8" id="lbltotal_adq"></h4>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-6 col-lg-3 mb-2">
                <div class="card border-0 h-100" style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                  ...
                  <div class="card-body placeholder-glow" id="placeholder-ultimo-bien">
              ...
              <div class="col-6 col-lg-3 mb-2">
                <div class="card border-0 h-100" style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                  ...
                  <div class="card-body placeholder-glow" id="placeholder-ultima-baja">
                    ...
                    <div class="row text-center">
                      ...
                      <div class="col-lg-9" style="align-content: center;">
                        <h6 class="placeholder col-8" id="lblultimabaja"></h6>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12 mb-3">
                    <div class="card border-0"  style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                      ...
                      <div class="card-body placeholder-glow" id="placeholder-estado-bienes">
                        ...
                        <div class="row text-center">
                          <div class="col-lg-12">
                            <span class="placeholder col-12" style="height: 250px; display: block;"></span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    <div class="card border-0" style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                      ...
                      <div class="card-body placeholder-glow" id="placeholder-balance-patrimonial">
                        <h3 class="card-title text-pink">
                          <span class="placeholder col-8"></span>
                        </h3>
                        <div class="row">
                          <div class="col-12">
                            <span class="placeholder col-12" style="height: 320px; display: block;"></span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-lg-7">
                <div class="card border-0" style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                  ...
                  <div class="card-body placeholder-glow" id="placeholder-dependencia-bienes">
                    ...
                    <div class="row text-center">
                      <div class="col-lg-12">
                        <span class="placeholder col-12" style="height: 666px; display: block;"></span>
                      </div>
                    </div>
                  </div>
                </div>
