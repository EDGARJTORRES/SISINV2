        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm" style="background-image: url(../../static/illustrations/perfil.jpeg)"></span>
                    <div class="d-none d-xl-block ps-2">
                    <div></div>
                    <div class="mt-1 small text-secondary"><?php echo $_SESSION["pers_nombre_siin"] ?></div>
                    <div><?php echo $_SESSION["pers_apellidos_siin"] ?></div>
                    </div>
                </a>  
                <a href="#">
