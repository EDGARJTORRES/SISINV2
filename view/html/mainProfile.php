<header class="navbar navbar-expand-md d-print-none" data-bs-theme="dark">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <img src="../../static/illustrations/cumplimiento-de-pedidos.png" width="110" height="32" alt="RRHH" class="navbar-brand-image">
        </h1>
       <input type="hidden" id="usu_idx" value="<?php echo $_SESSION["usua_id_siin"] ?>">
       <input type="hidden" id="rol_idx" value="<?php echo $_SESSION["rol_id_siin"] ?>">        
        <?php
        // Validación de sesión
        if (isset($_SESSION["usua_id_c_b"])) {
            $usuario = $_SESSION["pers_nombre_c_b"];
            $perfil = isset($_SESSION["rol_nombre_c_b"]) ? $_SESSION["rol_nombre_c_b"] : "Sin perfil";
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span id="foto_avatar" class="avatar avatar-sm" 
                          style="background-image: url(../../static/illustrations/perfil.jpeg)">
                    </span>
                    <div class="d-none d-xl-block ps-2">
                    <div class="mt-1 small text-white">
                      <?php echo $_SESSION["pers_nombre_siin"] ?> 
                      <?php echo $_SESSION["pers_apellidos_siin"] ?>
                    </div>
                    <div id="tipo_rol" class="small mt-1 text-uppercase"></div>

                    </div>
                </a>           
               <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-theme="light">
                <a href="../usuProfile/" class="dropdown-item d-lg-inline-block">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle"  data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                      <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-augmented-reality-2  me-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 21h-2a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v3.5" /><path d="M17 17l-4 -2.5l4 -2.5l4 2.5v4.5l-4 2.5z" /><path d="M13 14.5v4.5l4 2.5" /><path d="M17 17l4 -2.5" /><path d="M11 4h2" /></svg>
                      </span>
                      <span class="nav-link-title">
                          Procesos
                      </span>
                  ...
                  <div class="dropdown-menu">
                      <div class="dropdown-menu-columns">
                          <div class="dropdown-menu-column">
                              <a class="dropdown-item d-lg-inline-block" href="../adminAsignacionBien/">
                              ...
                              <a class="dropdown-item d-lg-inline-block" href="../adminDesplazamientoBien/">
                          ...
                          <div class="dropdown-divider"></div>
                              <a class="dropdown-item d-lg-inline-block" href="../adminAltaBien/">
                              ...
                              <a class="dropdown-item d-lg-inline-block" href="../adminMntDependencias/">
                          ...
                          <div class="dropdown-divider"></div> 
                              <a class="dropdown-item d-lg-inline-block" href="../adminDocumentosFirmados/">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                          <a class="dropdown-item" href="../adminMntObjetos/">
                          ...
                          <div class="dropend">
                            <a class="dropdown-item dropdown-toggle show" href="#sidebar-cards" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="true">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-tool  me-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 10h3v-3l-3.5 -3.5a6 6 0 0 1 8 8l6 6a2 2 0 0 1 -3 3l-6 -6a6 6 0 0 1 -8 -8l3.5 3.5" /></svg>
                                Mantenimiento Generales
                            </a>
                            <div class="dropdown-menu show" data-bs-popper="static">
                              <a href="../adminMntGeneralesGG/" class="dropdown-item">
                              ...
                              <a href="../adminMntGeneralesClase/" class="dropdown-item">
                              ...
                              <a href="../adminMntGeneralesMarca/" class="dropdown-item">
                              ...
                              <a href="../adminMntGeneralesModelo/" class="dropdown-item">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-blocks me-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 4a1 1 0 0 1 1 -1h5a1 1 0 0 1 1 1v5a1 1 0 0 1 -1 1h-5a1 1 0 0 1 -1 -1z" /><path d="M3 14h12a2 2 0 0 1 2 2v3a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-10a2 2 0 0 1 2 -2h3a2 2 0 0 1 2 2v12" /></svg>
                                Modelo
                              </a>
                              <a href="../adminMntGeneralesColor/" class="dropdown-item">
                               <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-paint me-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 3m0 2a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2z" /><path d="M19 6h1a2 2 0 0 1 2 2a5 5 0 0 1 -5 5l-5 0v2" /><path d="M10 15m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z" /></svg>
                                Color
                              </a>
                              <a href="../adminMntGeneralesCuentasContables/" class="dropdown-item">
                               <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-library me-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 3m0 2.667a2.667 2.667 0 0 1 2.667 -2.667h8.666a2.667 2.667 0 0 1 2.667 2.667v8.666a2.667 2.667 0 0 1 -2.667 2.667h-8.666a2.667 2.667 0 0 1 -2.667 -2.667z" /><path d="M4.012 7.26a2.005 2.005 0 0 0 -1.012 1.737v10c0 1.1 .9 2 2 2h10c.75 0 1.158 -.385 1.5 -1" /><path d="M11 7h5" /><path d="M11 10h6" /><path d="M11 13h3" /></svg>
                                Cuenta Contable
                              </a>
                            </div>
                          </div>  
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                          <a class="dropdown-item" href="../ConsultaBien/">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-qrcode mx-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4m0 1a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" /><path d="M7 17l0 .01" /><path d="M14 4m0 1a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" /><path d="M7 7l0 .01" /><path d="M4 14m0 1a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" /><path d="M17 7l0 .01" /><path d="M14 14l3 0" /><path d="M20 14l0 .01" /><path d="M14 14l0 3" /><path d="M14 20l3 0" /><path d="M17 17l3 0" /><path d="M20 17l0 3" /></svg>
                            Bienes por Código
                          </a>
                          <a class="dropdown-item" href="../ConsultaBienDependencia/">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-door mx-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 12v.01" /><path d="M3 21h18" /><path d="M6 21v-16a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v16" /></svg>
              ...
              <li class="nav-item">
                  <a class="nav-link" href="../adminFormatosBienes/" >
                      <span class="nav-link-icon d-md-none d-lg-inline-block">
                          <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-clipboard-data"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" /><path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v1h-6z" />
                              <path d="M9 17v-4" />
                              <path d="M12 17v-1" />
                              <path d="M15 17v-2" />
                          </svg>
              ...
              <li class="nav-item">
                <a class="nav-link" href="../adminHistorial/" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
