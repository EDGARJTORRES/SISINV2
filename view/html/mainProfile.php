<header class="navbar navbar-expand-md navbar-overlap d-print-none" data-bs-theme="dark">
    <div class="container-xl">
        ...
        <div class="dropdown-menu-arrow">
            <div class=" dropdown-item d-lg-inline-block ms-2">Municipalidad</div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="dropdown-menu-column">
                            <a class="dropdown-item" href="../adminMntGenerales/">
                        ...
                        <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-divider"></div>
                                <a class="dropdown-item d-lg-inline-block" href="../adminAltaBien/">
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-device-imac-plus me-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12.5 17h-8.5a1 1 0 0 1 -1 -1v-12a1 1 0 0 1 1 -1h16a1 1 0 0 1 1 1v8.5" /><path d="M3 13h13.5" /><path d="M8 21h4.5" /><path d="M10 17l-.5 4" /><path d="M16 19h6" /><path d="M19 16v6" /></svg>
                                    Alta de Bienes
                                </a>     
