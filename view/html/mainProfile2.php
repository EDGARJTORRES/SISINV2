<header class="navbar navbar-expand-md d-print-none" data-bs-theme="dark">
  <div class="container-xl">
    ...
    <div class="d-flex align-items-center">
      <img src="../../static/illustrations/logomuni3.png" width="110" height="32" alt="Tabler" class="navbar-brand-image me-2">
      <div class="d-flex flex-column text-start">
        <span class="dropdown-item d-lg-inline-block ms-2">Municipalidad</span>
        <span class="dropdown-item d-lg-inline-block ms-2">Provincial de Chiclayo</span>
      </div>
    </div>
