<div id="modalDependencias" class="modal fade" data-backdrop="static" data-keyboard="false" style="overflow-y: scroll;">
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    ...
                                                    <p class="mg-b-0">Objetos actuales en el area: </p>
                                                </div>
                                            </div><!-- d-flex -->
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control select2" style="width: 100%" id="combo_gg_tabla_obj" name="combo_gg_tabla_obj" required>
