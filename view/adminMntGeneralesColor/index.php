                ...
                <div class="row">
                    <div class="col-4 mb-3">
                        ...
                        <div class="card-body text-center">
                            ...
                            Escribe el nombre del color para clasificar los equipos de forma visual y organizada.
                            </p>
                            <button class="button2" id="add_button" onclick="nuevocolor()">
                    ...
                    <div class="col-8 mb-3">
                        <div class="card border-0" style="box-shadow: rgb(116, 142, 152) 0px 4px 16px -8px;">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">
                                    <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-list-search"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M15 15m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /> <path d="M18.5 18.5l2.5 2.5" /><path d="M4 6h16" /><path d="M4 12h4" />
                                    <path d="M4 18h4" />
                                    </svg>
                                    LISTADO DE REGISTROS DE COLORES
                                </h3>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive mx-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex flex-wrap align-items-center gap-3">
                                                <div class="d-flex align-items-center gap-2 ">
                                                    <button type="button" class="btn bg-black text-light"
                                                        id="eliminar_colores">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="number" id="cantidad_registros" style="width: 90px;"
                                                            class="form-control" min="1" max="25" value="10">
                                                    </div>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center gap-3 mt-4">
                                                <span id="contador_seleccionados" class="fw-normal text-dark">
                                                    Se encontraron
                                                    <span class="px-3 py-1 rounded-4 bg-primary text-white fw-bold mx-1"
                                                        id="contador_valor">0</span>
                                                    elementos
                                                </span>
                                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <table id="color_data" class="table card-table table-vcenter text-nowrap datatable" style="width:99%">
                                        <thead>
                                            <tr>
            ...
            <div class="content-left">
                <div class="icon-bg">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="icon-check">
