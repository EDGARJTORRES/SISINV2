...
switch ($_GET["op"]){
    ...
    case "listar_gg_bienes":
        ...
        $data = $grupogenerico->get_grupogenerico_bienes_paginado($start, $length, $search);
        $total = $grupogenerico->get_total_bienes();
        $totalFiltrado = $grupogenerico->get_total_bienes_filtrado($search);
