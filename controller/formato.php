...
switch ($_GET["op"]) {
    ...
    case "imprimir_formato":
        ...
        $header = [utf8_decode("N°"), utf8_decode("Cod Patr."), utf8_decode("Cod Int"), utf8_decode("Denominación"), "Marca", "Modelo", "Color", utf8_decode("N° Serie"), "Estado", utf8_decode("Observación")];
        $pdf->Row($header);
